...
public class Endereco extends Historico {
	...
	private void validarTamanhoMaximoDeDados() {
		if (endereco != null
				&& endereco.length() > TamanhoMaximoEndereco.ENDERECO) {
			adicionarErro("Insira um Endereço contendo até "
					+ TamanhoMaximoEndereco.ENDERECO + " caracteres.");
		}

		if (numero != null && numero.length() > TamanhoMaximoEndereco.NUMERO) {
			adicionarErro("Insira um Número contendo até "
					+ TamanhoMaximoEndereco.NUMERO + " caracteres.");
		}

		if (complemento != null
				&& complemento.length() > TamanhoMaximoEndereco.COMPLEMENTO) {
			adicionarErro("Insira um Complemento contendo até "
					+ TamanhoMaximoEndereco.COMPLEMENTO + " caracteres.");
		}

		if (bairro != null && bairro.length() > TamanhoMaximoEndereco.BAIRRO) {
			adicionarErro("Insira um Bairro contendo até "
					+ TamanhoMaximoEndereco.BAIRRO + " caracteres.");
		}
	}
	...
	public String toString() {
		return "Endereco [id=" + id + ", dataInicialVigencia="
				+ DataHoraUtils.formatarDataHora(dataInicialVigencia)
				+ ", dataFinalVigencia="
				+ DataHoraUtils.formatarDataHora(dataFinalVigencia) + ", uf=" + uf
				+ ", cep=" + cep + ", municipio=" + municipio + ", bairro="
				+ bairro + ", endereco=" + endereco + ", numero=" + numero
				+ ", complemento=" + complemento + ", zona=" + zona + ", pais="
				+ pais + "]";
	}
}
