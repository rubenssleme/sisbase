...
insert into atendimento_grupo_atendimento_usuario(
	...
	where gru.ativo = true and excluido = false and nom.nome = 'G07' and gru.turma = '05' and mod.nome = 'Atendimento Específico Especializado' and ate.data in ('09/10/2015'));