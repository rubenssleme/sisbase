...
public class ModeloTabelaAtendimentoPreCadastro extends ModeloTabela<AtendimentoPreCadastroDTO> {
    ...
    public ModeloTabelaAtendimentoPreCadastro() {
        super(new String[]{"Nome", "Frequência", "Descrição Individual", "Participação", "Tipo", "Instituição", "DRE / CEFAI", "Diretoria de Ensino", "Formação", "Nome da Origem"},
                ...
                new int[]{200, 60, 190, 130, 150, 300, 300, 300, 300, 300});
    }
    ...
    protected void adicionarDado(AtendimentoPreCadastroDTO objetoDto) {
        addRow(new Object[]{objetoDto.getPreCadastroDto().getInformacaoEssencialDto().getNome(),
                    ...
                    objetoDto.getInformacaoAtendimentoDto().getParticipacaoDto() != null ? objetoDto.getInformacaoAtendimentoDto().getParticipacaoDto().toString() : null,
