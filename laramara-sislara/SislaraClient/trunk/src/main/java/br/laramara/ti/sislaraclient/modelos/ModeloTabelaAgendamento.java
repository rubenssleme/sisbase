...
public class ModeloTabelaAgendamento extends ModeloTabela<AgendamentoDTO> {
    ...
    public ModeloTabelaAgendamento (){
        super(new String[]{"Data", "Hora Início", "Hora Termino", "Prontuário", "Nome/Grupo", "Status", "Reservador Para", "Nome Contato", "Telefone Contato", "Setor", "Profissional", "Tipo de Atendimento", "Descricao do Tipo de Atendimento", "Modulo/Atividade", "Sala", "OBS", "Dia da Semana", "Motivo do Cancelamento", "Justificativa do Cancelamento", "Responsáveis por Operações", "ID", "Prontuário Criado"},
                new Class[] {Date.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, Long.class, Long.class},
                new int[]{100, 80, 80, 80, 400, 100, 300, 400, 400, 150, 300, 350, 400, 400, 400, 500, 100, 300, 500, 2000, 50, 20});
    }
