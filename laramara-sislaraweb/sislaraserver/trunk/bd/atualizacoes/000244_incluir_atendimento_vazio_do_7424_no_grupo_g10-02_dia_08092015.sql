...
insert into atendimento_grupo_atendimento_usuario(
	...
	where gru.ativo = true and excluido = false and nom.nome = 'G10' and gru.turma = '02' and mod.nome = 'Atendimento Específico Especializado' and ate.data in ('08/09/2015'));