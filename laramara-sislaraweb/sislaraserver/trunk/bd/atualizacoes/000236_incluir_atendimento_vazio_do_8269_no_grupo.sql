...
insert into atendimento_usuario(id_usuario, id_informacao_atendimento)values(8269, currval('informacao_atendimento_id_seq'));
insert into atendimento_grupo_atendimento_usuario(
	...
	where gru.ativo = true and excluido = false and nom.nome = 'GJ01' and gru.turma = '03' and mod.nome = 'Atividades Pedagogicas' and ate.data = '26/08/2015');