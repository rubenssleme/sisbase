...
where infatepro.frequencia = 'FP' and gru.ativo = true and ategru.status ='NORMAL' and nom.nome like 'G04' and gru.turma like '11' and ategru.data in ('2016-03-30', '2016-03-23', '2016-04-13', '2016-05-11')
