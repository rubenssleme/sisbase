...
public class TestesAtendimento {
	...
	public void atendimento_gera_atendimentos_por_usuario_e_pre_cadastro() {
		...
		AtendimentoGrupo atendimento = new AtendimentoGrupo(ContextoGrupo.fabricarGrupoComTodosOsDados(),
				ContextoModulo.fabricarComTodosOsDados(), usuarios, preCadastros, profissionais);
