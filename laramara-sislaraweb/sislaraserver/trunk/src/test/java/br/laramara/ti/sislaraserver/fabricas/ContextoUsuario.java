...
public class ContextoUsuario {
	...
	public static UsuarioDTO construirUsuarioDTOComIdentificacaoAlternativa() {
		UsuarioDTO usuarioDto = construirUsuarioDTO();
		usuarioDto.setId(new Long(18888));
		return usuarioDto;
	}
	...
	public static UsuarioDTO construirUsuarioDTO() {
		...
		List<OrigemEncaminhamentoDetalhadoDTO> encaminhamentosDTO = new ArrayList<>();
		encaminhamentosDTO.add(ContextoOrigemEncaminhamentoDetalhado.fabricarEncaminhamentoDto());
		...
		usuarioDto.setStatusUsuarioAtualDto(new StatusRelacaoComModuloDTO(Status.DESISTENTE.toString()));
		...
		usuarioDto.setOrigemEncaminhamentosDetalhadosDto(encaminhamentosDTO);
		...
		usuarioDto.setVulnerabilidadeUsuarioDto(Arrays.asList(ContextoVulnerabilidade.contruirDto()));
		usuarioDto.setEncaminhamentosDto(Arrays
				.asList(new FabricaEncaminhamento().converterParaDTO(ContextoEncaminhamento.fabricarEncaminhamento())));
		...
		usuarioDto.setRecursosRelacionamentoDto(Arrays.asList(ContextoRecursoRelacionamento.construirRecursoRelacionamentoDTO()));
	...
	public static Usuario fabricarUsuarioSemClassificacaoSocial() {
		...
		List<OrigemEncaminhamentoDetalhado> encaminhamentos = new ArrayList<>();
		encaminhamentos.add(ContextoOrigemEncaminhamentoDetalhado.fabricarOrigemEncaminhamentoDetalhado());

		Usuario usuario = new Usuario();
		usuario.inicializarStatusUsuario();
		usuario.setVersao("1233");
		usuario.setInformacaoEssencial(informacaoEssencial);
		usuario.setFalecido(true);
		...
		usuario.setOrigemEncaminhamentosDetalhados(encaminhamentos);
		usuario.setEncaminhamentos(Arrays.asList(ContextoEncaminhamento.fabricarEncaminhamento()));
		...
		usuario.setVulnerabilidadeUsuario(Arrays.asList(ContextoVulnerabilidade.construir()));
		...
		recursos.add(new Recurso(new Long(100), "BENGALA", false, true,"80,00"));
		usuario.setRecursosRelacionamentos(
				Arrays.asList(ContextoRecursoRelacionamento.construirRecursoRelacionamento()));
