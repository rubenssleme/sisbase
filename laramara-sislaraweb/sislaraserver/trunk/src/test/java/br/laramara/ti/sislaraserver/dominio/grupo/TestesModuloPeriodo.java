...
public class TestesModuloPeriodo {
	...
	public void moduloperiodo_adiciona_relacao_modulo_usuario_integrado() {
		...
		EspecificacaoGeracaoAtendimento especificacaoGeracaoAtendimento = new EspecificacaoGeracaoAtendimento(
				moduloPeriodo.getId(), "31/12/2010", new Horario("08:00", "12:00"));
		moduloPeriodo.gerarAtendimentosDeGrupo(grupo, moduloPeriodo.getModulo(), especificacaoGeracaoAtendimento);
