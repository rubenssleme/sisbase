...
public class ContextoDescricaoTipoAtendimento {
	...
	public static DescricaoTipoAtendimentoDTO construirDescricaoTipoAtendimentoDTOCursos() {
		Long id = new Long(50);
		String nome = "Cursos";
		String sigla = "CURS";
		String descricaoTipoAtendimentoDTO = "Texto da descrição";
		List<SetorDTO> setoresDto = new ArrayList<>();
		setoresDto.add(new SetorDTO("CTO"));
		setoresDto.add(new SetorDTO("PROCEJA"));

		TipoAtendimentoDTO tipoAtendimentoDto = new TipoAtendimentoDTO();
		tipoAtendimentoDto.setId(new Long(8));
		tipoAtendimentoDto.setNome("Capacitações");

		List<NomeGrupoDTO> nomesGruposDto = new ArrayList<>();
		nomesGruposDto.add(new NomeGrupoDTO(new Long(51), "CURS"));

		List<ModuloDTO> modulosDto = new ArrayList<>();

		modulosDto.add(new ModuloDTO(new Long(64), "Braille"));

		DescricaoTipoAtendimentoDTO descricaoTipoAtendimentoDto = new DescricaoTipoAtendimentoDTO();
		descricaoTipoAtendimentoDto.setId(id);
		descricaoTipoAtendimentoDto.setNome(nome);
		descricaoTipoAtendimentoDto.setDescricao(descricaoTipoAtendimentoDTO);
		descricaoTipoAtendimentoDto.setSigla(sigla);
		descricaoTipoAtendimentoDto.setSetoresDto(setoresDto);
		descricaoTipoAtendimentoDto.setTipoAtendimentoDto(tipoAtendimentoDto);
		descricaoTipoAtendimentoDto.setNomesGruposDto(nomesGruposDto);
	...
	public static DescricaoTipoAtendimento fabricarCursos() {
		Long id = new Long(50);
		String nome = "Cursos";
		String sigla = "CURS";
		String descricao = "Texto da descrição";
		List<Setor> setores = new ArrayList<>();
		setores.add(Setor.CTO);
		setores.add(Setor.PROCEJA);

		TipoAtendimento tipoAtendimento = new TipoAtendimento();
		tipoAtendimento.setId(new Long(8));
		tipoAtendimento.setNome("Capacitações");

		List<NomeGrupo> nomesGrupos = new ArrayList<>();
		nomesGrupos.add(new NomeGrupo(new Long(51), "CURS"));

		List<Modulo> modulosDto = new ArrayList<>();

		modulosDto.add(new Modulo(new Long(64), "Braille"));

		DescricaoTipoAtendimento descricaoTipoAtendimento = new DescricaoTipoAtendimento();
		descricaoTipoAtendimento.setId(id);
		descricaoTipoAtendimento.setNome(nome);
		descricaoTipoAtendimento.setDescricao(descricao);
		descricaoTipoAtendimento.setSigla(sigla);
		...
		descricaoTipoAtendimento.setModulos(modulosDto);
	...
	public static DescricaoTipoAtendimento fabricarAvaliacaoFuncional() {
		DescricaoTipoAtendimento descricaoTipoAtendimento = new DescricaoTipoAtendimento();
		descricaoTipoAtendimento.setId(DescricaoTipoAtendimento.ID_AVALIACAO_FUNCIONAL);
		return descricaoTipoAtendimento;
	}
	
	public static DescricaoTipoAtendimentoDTO construirDescricaoPsicologia() {
		TipoAtendimentoDTO tipoAtendimentoDTO = new TipoAtendimentoDTO();
		tipoAtendimentoDTO.setId(new Long(6));
		tipoAtendimentoDTO.setNome("Atenção Psicossocial");
		
		DescricaoTipoAtendimentoDTO descricaoTipoAtendimentoDTO = new DescricaoTipoAtendimentoDTO();
		descricaoTipoAtendimentoDTO.setId(DescricaoTipoAtendimento.ID_PSICOLOGIA);
		descricaoTipoAtendimentoDTO.setTipoAtendimentoDto(tipoAtendimentoDTO);
		descricaoTipoAtendimentoDTO.setNomesGruposDto(Arrays.asList());
		return descricaoTipoAtendimentoDTO;
	}
}
