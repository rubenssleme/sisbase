...
public class TestesFabricaEspecificacaoGeracaoDemanda {
	...
	public void fabrica_especificacao_geracao_demanda_converte_objeto_de_dto_para_dominio() {
		...
		Assert.assertEquals(especificacaoGeracaoDemanda.getRecursosEDescricaoRecurso().size(),
				especificacaoGeracaoDemandaDto.getRecursosEDescricaoRecursoDto().size());
		...
		Assert.assertEquals(especificacaoGeracaoDemanda.getDataExpectativa(),
				especificacaoGeracaoDemandaDto.getDataExpectativa());
	}
}
