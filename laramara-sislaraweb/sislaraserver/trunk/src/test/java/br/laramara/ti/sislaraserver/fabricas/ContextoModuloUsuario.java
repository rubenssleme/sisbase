...
public class ContextoModuloUsuario {
	...
	public static ModuloUsuarioDTO fabricarModuloUsuarioAlternativoBDTO() {
		ModuloUsuarioDTO moduloUsuarioDTO = fabricarModuloUsuarioDTO();
		moduloUsuarioDTO.setUsuarioDto(ContextoUsuario.construirUsuarioDTOComIdentificacaoAlternativoB());
		return moduloUsuarioDTO;
	}
}
