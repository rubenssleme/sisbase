...
public class ContextoFamiliar {
	...
	public static Familiar fabricarFamiliarComTodosOsDados() {
		...
		familiar.setGenero(Genero.FEMININO);
		familiar.setPeriodoBeneficios(Arrays.asList(ContextoPeriodoBeneficio.construirComTodosOsDados()));
		familiar.setObs("Texto de obs.");
		familiar.setFalecido(true);
		familiar.setVulnerabilidades(Arrays.asList(ContextoVulnerabilidade.construir()));
		return familiar;
	}
	...
	public static FamiliarDTO construirFamiliarDTO() {
		...
		familiarDto.setGeneroDto(new GeneroDTO("MASCULINO"));
		familiarDto.setPeriodoBeneficiosDto(Arrays.asList(ContextoPeriodoBeneficio.construirPeriodoBeneficioDTO()));
		familiarDto.setObs("Texto de obs.");
		familiarDto.setFalecido(true);
		familiarDto.setVulnerabilidadesDto(Arrays.asList(ContextoVulnerabilidade.contruirDto()));
		return familiarDto;
	}
