...
public class TestesFabricaAgendamento {
	...
	public void fabrica_agendamento_converte_objeto_de_dominio_para_dto() {
		...
		agendamento.setInformacaoAdicional("TExto de informação adicional.");
		...
		Assert.assertEquals(agendamentoDtoCovertido.getInformacaoAdicional(), agendamento.getInformacaoAdicional());
	}
	...
	public void fabrica_agendamento_converte_objeto_dto_para_dominio() {
		...
		agendamentoDto.setInformacaoAdicional("Texto de informação adiciconal.");
		...
		Assert.assertEquals(agendamentoCovertido.getInformacaoAdicional(), agendamentoDto.getInformacaoAdicional());
	}
}
