...
public class Modulo {
	...
	public static final Long ID_MODULO_CURSO_DE_AUTONOMIA_E_INDEPENDENCIA = new Long(109);
	public static final Long ID_MODULO_SER_ADOLESCENTE = new Long(142);
	public static final Long ID_MODULO_HISTORIAS_DE_ESCOLA = new Long(143);
	public static final Long ID_MODULO_EDUCACAO_TECNOLOGICA = new Long(141);
	public static final Long ID_MODULO_ATIVIDADES_FUNCIONAIS = new Long(34);
	public static final Long ID_MODULO_AUTONOMIA_E_INDEPENDENCIA = new Long(140);
	...
	public static Modulo fabricaModuloReuniaoDeIntegracao(){
		return new Modulo(ID_MODULO_REUNIAO_INTEGRACAO, "");
	}
	...
	public static Modulo fabricaModuloAvaliacaoETriagem() {
		return new Modulo(ID_MODULO_AVALIACAO_TRIAGEM, "");
	}
	
	public static Modulo fabricaModuloExcessoFaltas() {
		return new Modulo(ID_MODULO_EXCESSO_FALTA, "");
	}
	...
	public boolean eCursoDeAutonomiaEIndependencia() {
		return id.equals(ID_MODULO_CURSO_DE_AUTONOMIA_E_INDEPENDENCIA);
	}
	
	public boolean eSerAdolescente() {
		return id.equals(ID_MODULO_SER_ADOLESCENTE);
	}
	
	public boolean eHistoriasDaEscola() {
		return id.equals(ID_MODULO_HISTORIAS_DE_ESCOLA);
	}
	
	public boolean eAutonomiaEIndependencia() {
		return id.equals(ID_MODULO_AUTONOMIA_E_INDEPENDENCIA);
	}
	
	public boolean eEducacaoTecnologica() {
		return id.equals(ID_MODULO_EDUCACAO_TECNOLOGICA);
	}

	public boolean eAtividadesFuncionais() {
		return id.equals(ID_MODULO_ATIVIDADES_FUNCIONAIS);
	}
