...
public abstract class AtendimentoBase extends Validavel {
	...
	protected boolean atendimentoNormalContendoTodosProfissionaisComFrequenciaFP(
			List<AtendimentoProfissional> atendimentosProfissionais) {
		return estaNormal() && todosOsProfissionaisPossuemFrequenciaFP(atendimentosProfissionais);
	}
