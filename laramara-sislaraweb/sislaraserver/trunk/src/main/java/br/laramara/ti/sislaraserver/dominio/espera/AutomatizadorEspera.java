...
public class AutomatizadorEspera extends Automatizador {
	...
	public static boolean verificarSeJaPossuiAgendamentoFuturoComMesmaDescricaoTipoAtendimentoEModulo(
			Espera esperaObtido, Agendamento agendamentoAMarcar, RepositorioAgendamento repositorioAgendamento) {
		return repositorioAgendamento.obterAgendadosFuturosComInformacaoEssencial(esperaObtido).stream()
				.anyMatch(agendamento -> agendamento.estaAgendado()
						&& agendamento.possuiDescricaoEModuloIdentico(agendamentoAMarcar)
						&& !agendamento.podeTerAgendamentosMultiplosFuturos());
	}
}
