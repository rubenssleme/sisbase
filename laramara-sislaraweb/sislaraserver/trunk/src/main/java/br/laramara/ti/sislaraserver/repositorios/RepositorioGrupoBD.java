...
public class RepositorioGrupoBD extends RepositorioDB<Grupo> implements
	...
	public Grupo obterGrupoAtivoEPublicadoComDescricaoTipoAtendimentoDeCursosPorIdGrupo(Long idGrupo) {
		return cacheGrupo.obterGrupoAtivoEPublicadoComDescricaoTipoAtendimentoDeCursosPorIdGrupo(idGrupo);
	}
	
	@Override
	public List<Grupo> obterGruposAtivosEPublicadosComDescricaoTipoAtendimentoDeCursos() {
		return cacheGrupo.obterGruposAtivosEPublicadosComDescricaoTipoAtendimentoDeCursos();
	}
		...
		if (!nomeGrupo.isEmpty()) {
			try {
				TypedQuery<Grupo> query = em
						.createQuery(
								"SELECT g FROM Grupo g JOIN g.nomeGrupo n WHERE LOWER(n.nome||'-'||g.turma) LIKE :nomeGrupo AND g.ativo is FALSE AND g.excluido is FALSE",
								Grupo.class);
	...
	@Override
	public List<Grupo> obterTodosAtivos() {
		return cacheGrupo.obterAtivos(true, null, false);
	}
	...
	public Grupo obterGrupoAtivoMaisRecenteDeReuniaoDeIntegracaoComUsuarioIntegrado(Usuario usuario) {
		return cacheGrupo.obterGrupoAtivoMaisRecenteDeReuniaoDeIntegracaoComUsuarioIntegrado(usuario);
	}
	...
	public List<ModuloPeriodo> obterModuloPeriodoServicoSocialReuniaoIntegracaoAtivosComDataFutura(
		...
		return cacheGrupo.obterModuloPeriodoServicoSocialReuniaoIntegracaoAtivosComDataFutura(moduloPeriodo);
	}
	...
	public List<Grupo> obterGruposDescricaoServicoSocialModuloReuniaoDeIntegracaoAtivos() {
		return cacheGrupo.obterGruposDescricaoServicoSocialModuloReuniaoDeIntegracaoAtivos(
				DescricaoTipoAtendimento.fabricarDescricaoServicoSocial(), Modulo.fabricaModuloReuniaoDeIntegracao());
	}
	
	@Override
	public List<Grupo> obterGruposAtivosComDescricaoEModulo(DescricaoTipoAtendimento descricaoTipoAtendimento,
			Modulo modulo) {
		return cacheGrupo.obterGruposDescricaoServicoSocialModuloReuniaoDeIntegracaoAtivos(descricaoTipoAtendimento,
				modulo);
	}
	...
	public List<Grupo> obterTodosAtivosComModuloAEE() {
		return cacheGrupo.obterAtivosComModuloPeriodoAEE();
	}
