...
public class FabricaDemanda extends FabricaRecursiva<DemandaDTO, Demanda> {
	...
	public Demanda converterParaDominio(DemandaDTO demandaDto, Demanda demanda) {
		if (demandaDto != null) {
			...
			demanda.setDataExpectativa(demandaDto.getDataExpectativa());
		}
		return demanda;
	}
	...
	public DemandaDTO converterParaDTO(Demanda demanda) {
		...
		demandaDto.setRecursoDto(new FabricaRecurso().converterParaDTO(demanda
				.getRecurso()));
		demandaDto
				.setDescricaoRecursoDTO(new FabricaDescricaoRecurso().converterParaDTO(demanda.getDescricaoRecurso()));
		...
		demandaDto.setDataExpectativa(demanda.getDataExpectativa());
		return demandaDto;
	}
