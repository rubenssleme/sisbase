...
public class HistoricoStatusAgendamento extends HistoricoOperacao{
	...
	public String toString() {
		return "HistoricoStatusAgendamento [status=" + status
				+ ", contaAcesso=" + contaAcesso + ", dataInicialVigencia="
				+ DataHoraUtils.formatarDataHora(dataInicialVigencia) + ", dataFinalVigencia=" + DataHoraUtils.formatarDataHora(dataFinalVigencia) + "]";
	}
}
