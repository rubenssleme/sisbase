...
public class DescricaoTipoAtendimento {
	...
	public static final Long ID_INFORMATICA_E_OUTRAS_TECNOLOGIAS_ASSISTIVAS = new Long(4);
	public static final Long ID_AE_ARTES = new Long(9);
	public static final Long ID_AE_MUNDO_DO_TRABALHO = new Long(61);
	public static final Long ID_ATIVIDADE_FISICA = new Long(65);
	...
	public static DescricaoTipoAtendimento fabricarDescricaoAtendimentoEspecializadoGlobal() {
		return new DescricaoTipoAtendimento(ID_ATENDIMENTO_ESPECIALIZADO_GLOBAL);
	}
	...
	public static DescricaoTipoAtendimento fabricarDescricaoServicoSocial() {
		return new DescricaoTipoAtendimento(ID_SERVICO_SOCIAL);
	}
	
	public static DescricaoTipoAtendimento fabricarDescricaoPsicologia() {
		return new DescricaoTipoAtendimento(ID_PSICOLOGIA);
	}
	
	public static DescricaoTipoAtendimento fabricarDescricaoAvaliacaoFuncional() {
		return new DescricaoTipoAtendimento(ID_AVALIACAO_FUNCIONAL);
	}
	...
	public boolean eAtividadeFisica() {
		return id.equals(ID_ATIVIDADE_FISICA);
	}
	...
	public boolean eAEArtes() {
		return id.equals(ID_AE_ARTES);
	}

	public boolean eAEMundoDoTrabalho() {
		return id.equals(ID_AE_MUNDO_DO_TRABALHO);
	}
	...
	public boolean eAtividadeDeVidaAutonoma() {
		return id.equals(ID_AE_ATIVIDADES_DE_VIDA_AUTONOMA);
	}
	...
	public boolean eInformaticaEOutrasTecnologiasAssistivas() {
		return id.equals(ID_INFORMATICA_E_OUTRAS_TECNOLOGIAS_ASSISTIVAS);
	}
