...
public class AutomatizadorTarefas {
	...
	//Executar somente uma vez ao ano, no dia 15/02.
	@Scheduled(cron = "0 0 0 15 2 ?")
	public void atualizarStatusDeUsuariosSomenteCTOMenor21AnosEmNenhumGrupoAtivoDeIntegradoParaRetorno() {
		automatizadorStatusUsuario.atualizarStatusDeUsuariosSomenteCTOMenor21AnosEmNenhumGrupoAtivoDeIntegradoParaRetorno();
	}
