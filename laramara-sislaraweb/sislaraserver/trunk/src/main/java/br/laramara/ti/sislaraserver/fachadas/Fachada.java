...
public abstract class Fachada {
	...
	@Inject
	protected RepositorioUsuarioExterno repositorioUsuarioExterno;
	@Inject
	...
	public static final String MENSAGEM_USUARIO_JA_AGENDADO = "O Usuário/Pré-cadastro já está agendado.";
	...
	protected static final String ERRO_SUA_SESSAO_EXPIROU_EFETUE_LOGIN_NOVAMENTE = "Sua sessão expirou. Efetue o login novamente.";
	...
	public boolean estaLogado(String token) {
		return repositorioUsuarioExterno.obterPorToken(token) != null;		
	}
	...
	protected String removerMarcacoes(String texto) {
		return texto.toString().replaceAll(", ", SEPARADOR).replaceAll("\\[", "").replaceAll("\\]", "")
				.replaceAll("null", "");
	}
	
	protected String obterFrequenciasDosDias(Map<String, Object> resultado) {
	...
	protected List<Integer> obterDiasDoMes() {
