...
import br.laramara.ti.sislaraserver.fachadas.externa.FachadaInscricao;
import br.laramara.ti.sislaraserver.fachadas.externa.FachadaUsuarioExterno;
...
public class ServicoSisLaraServerRmi implements ServicoSisLaraServer {
	...
	@Inject
	private FachadaUsuarioExterno fachadaUsuarioExterno;
	@Inject
	private FachadaInscricao fachadaInscricao;
	@Inject
	...
	@Override
	public ResultadoSolicitacaoRecuperacaoSenhaDTO efetuarSolicitacaoRecuperacaoSenha(String emailSolicitante) throws RemoteException {
		return fachadaSeguranca.efetuarSolicitacaoRecuperacaoSenha(emailSolicitante);
	}
	
	@Override
	public ResultadoSolicitacaoCadastroNovaSenhaDTO cadastrarNovaSenha(SolicitacaoCadastroNovaSenhaDTO solicitacaoAlteracaoSenhaDto) throws RemoteException {
		return fachadaSeguranca.cadastrarNovaSenha(solicitacaoAlteracaoSenhaDto);
	}

	@Override
	public ResultadoListagemTipoDescricaoEventoDTO obterListagemTipoDescricaoEvento() throws RemoteException {
		return fachadaGrupo.obterListagemTipoDescricaoEvento();
	}
	
	@Override
	public ResultadoValidacaoDescricaoEventoDTO validarDescricaoEvento(DescricaoEventoDTO descricaoEventoDto) {
		return fachadaGrupo.validarDescricaoEvento(descricaoEventoDto);
	}
	
	@Override
	public ResultadoAutenticacaoDTO autenticarUsuarioExterno(CredencialExternaDTO credencialExternaDto)
			throws RemoteException {
		return fachadaSeguranca.autenticarUsuarioExterno(credencialExternaDto);
	}
	...
	public ResultadoListagemSetorDTO obterListagemSetorParaProjetos()
			throws RemoteException {
		return fachadaUsuario.obterListagemSetorParaProjetos();
	}
	...
	public ResultadoValidacaoPeriodoComprometimentoDTO validarPeriodoComprometimento(
			...
			throws RemoteException {
		return fachadaUsuario.validarPeriodoComprometimento(periodoComprometimentoDto);
	}
	...
	public ResultadoListagemComprometimentoDTO obterListagemComprometimento()
			throws RemoteException {
		return fachadaUsuario.obterListagemComprometimento();
	}
	...
	public ResultadoEdicaoAtendimentoGrupoDTO editarAtendimentoGrupo(
			ModuloPeriodoDTO moduloPeriodoDTO, AtendimentoGrupoDTO atendimentoGrupoDto, TokenDTO tokenDto)
			throws RemoteException {
		return fachadaGrupo.editarAtendimentoGrupo(moduloPeriodoDTO, atendimentoGrupoDto, tokenDto);
	}
	...
	public ResultadoListagemOpcaoIntegracaoDTO obterListagemOpcaoIntegracao()
			throws RemoteException {
		return fachadaAtendimentoIndividual.obterListagemOpcaoIntegracao();
	}
	...
	public ResultadoListagemPrestacaoContaDTO obterListagemPrestacaoConta()
			throws RemoteException {
		return fachadaProjeto.obterListagemPrestacaoConta();
	}
	...
	@Override
	public ResultadoListagemRecursoDTO obterListagemRecursosDisponiveisParaDemanda()
			throws RemoteException {
		return fachadaGrupo.obterRecursosDisponiveisParaDemanda();
	}
	...
	@Override
	public ResultadoValidacaoRecursoDisponivelDTO validarRecursoDisponivel(
			RecursoDisponivelDTO recursoDisponivelDto) 
					throws RemoteException {
		return fachadaProjeto.validarRecursoDisponivel(recursoDisponivelDto);
	}
	...
	public ResultadoValidacaoParticipacaoDetalhadaDTO validarParticipacaoDetalhada(
		...
		return fachadaGrupo.validarParticipacaoDetalhada(participacaoDetalhadaDto);
	}

	@Override
	public ResultadoListagemServicoDTO obterListagemServico() throws RemoteException {
		return fachadaUsuario.obterListagemServico();
	}
	
	@Override
	public ResultadoListagemNecessidadeDTO obterListagemNecessidade() throws RemoteException {
		return fachadaUsuario.obterListagemNecessidade();
	}
	
	@Override
	public ResultadoListagemExpectativaDTO obterListagemExpectativa() throws RemoteException {
		return fachadaUsuario.obterListagemExpectativa();
	}

	@Override
	public ResultadoListagemRecursoMoradiaDTO obterListagemRecursoProximoMoradia() throws RemoteException {
		return fachadaUsuario.obterListagemRecursoProximoMoradia();
	}

	@Override
	public ResultadoListagemCondicaoMoradiaDTO obterListagemCondicaoMoradia() throws RemoteException {
		return fachadaUsuario.obterListagemCondicaoMoradia();
	}

	@Override
	public ResultadoListagemSituacaoHabitacionalDTO obterListagemSituacaoHabitacional() throws RemoteException {
		return fachadaUsuario.obterListagemSituacaoHabitacional();
	}

	@Override
	public ResultadoListagemHabitacaoDTO obterListagemHabitacao() throws RemoteException {
		return fachadaUsuario.obterListagemHabitacao();
	}

	@Override
	public ResultadoListagemTipoConstrucaoDTO obterListagemTipoConstrucao() throws RemoteException {
		return fachadaUsuario.obterListagemTipoConstrucao();
	}

	@Override
	public ResultadoListagemInfraestruturaBasicaDTO obterListagemInfraestruturaBasica() throws RemoteException {
		return fachadaUsuario.obterListagemInfraestrututraBasica();
	}

	@Override
	public ResultadoListagemTipoAcaoCondutaDTO obterListagemTipoAcaoConduta() throws RemoteException {
		return fachadaAtendimentoIndividual.obterListagemTipoAcaoConduta();
	}

	@Override
	public ResultadoListagemGrupoDTO obterListagemTodosGruposAtivos() throws RemoteException {
		return fachadaGrupo.obterListagemGrupoAtivo();
	}

	@Override
	public ResultadoValidacaoAcaoCondutaDTO validarAcaoConduta(AcaoCondutaDTO acaoCondutaDto) throws RemoteException {
		return fachadaAtendimentoIndividual.validarAcaoConduta(acaoCondutaDto);
	}

	@Override
	public String obterResumoIntegracao(String prontuario) throws RemoteException {
		return fachadaAtendimentoIndividual.obterResumoIntegracao(prontuario);
	}

	@Override
	public ArquivoDTO gerarRelatorioFrequenciasDeAtendimentoGlobaisPorUsuarioNoPeriodo(String prontuarios, String dataInicio,
			String dataTermino, TokenDTO tokenDto) throws RemoteException {
		return fachadaRelatorio.gerarRelatorioFrequenciasDeAtendimentosGlobaisPorUsuarioNoPeriodo(prontuarios, dataInicio,
				dataTermino, tokenDto);
	}

	@Override
	public ResultadoListagemOrigemEncaminhamentoDTO obterListagemOrigemEncaminhamento() throws RemoteException {
		return fachadaUsuario.obterListagemOrigemEncaminhamento();
	}

	@Override
	public ResultadoValidacaoEncaminhamentoDTO validarEncaminhamento(OrigemEncaminhamentoDetalhadoDTO encaminhamentoDto)
			throws RemoteException {
		return fachadaGrupo.validarOrigemEncaminhamentoDetalhado(encaminhamentoDto);
	}

	@Override
	public ResultadoCadastroInscricaoDTO cadastrarInscricao(
			SolicitacaoCadastroInscricaoDTO solicitacaoCadastroInscricaoDto) {
		return fachadaInscricao.cadastrarInscricao(solicitacaoCadastroInscricaoDto);
	}
	...
	public ResultadoCadastroUsuarioExternoDTO cadastrarUsuarioExterno(
		...
		return fachadaUsuarioExterno.cadastrarUsuarioExterno(solicitacaoCadastroUsuarioExternoDto);
	}

	@Override
	public ArquivoDTO gerarRelatorioPorcentagensFrequenciaPorGrupo(GrupoDTO grupoDto, ModuloPeriodoDTO moduloPeriodoDto,
			TokenDTO tokenDto) throws RemoteException {
		return fachadaRelatorio.gerarRelatorioPorcentagensFrequenciaPorGrupo(grupoDto,
				moduloPeriodoDto, tokenDto);
	}

	@Override
	public ArquivoDTO gerarRelatorioDeAvaliacaoPsicossocial(Long prontuario, TokenDTO tokenDto) throws RemoteException {
		return fachadaRelatorio.gerarRelatorioAvaliacaoPsicossocial(prontuario, tokenDto);
	}

	@Override
	public boolean tokenAtivo(TokenDTO tokenDTO) throws RemoteException {
		return fachadaSeguranca.tokenAtivo(tokenDTO);
	}

	@Override
	public ResultadoListagemDetalhesCursoDTO obterListagemDetalhesCursos() throws RemoteException {
		return fachadaGrupo.obterListagemDetalhesCursos();
	}
	...
	public ResultadoEdicaoUsuarioExternoDTO editarUsuarioExterno(
		...
		return fachadaUsuarioExterno.editarUsuarioExterno(solicitacaoEdicaoUsuarioExternoDto);
	}

	@Override
	public ResultadoConsultaPerfilPreenchidoDTO consultarPerfilPreenchido(TokenDTO tokenDto) throws RemoteException {
		return fachadaUsuarioExterno.consultarPerfilPreenchido(tokenDto);
	}
	
	@Override
	public ResultadoConsultaUsuarioExternoDTO obterUsuarioExternoPorToken(String tokenDto) throws RemoteException {
		return fachadaUsuarioExterno.obterUsuarioExternoPorToken(tokenDto);
	}
	
	@Override
	public ResultadoConsultaDetalheCursoDTO obterDetalheCursoPorIdGrupo(Long idGrupo) throws RemoteException {
		return fachadaGrupo.obterDetalheCursoPorIdGrupo(idGrupo);
	}
	
	@Override
	public ArquivoDTO obterArquivoProjetoDTO(ProjetoDTO projetoDto, ArquivoDTO arquivoDTO) throws RemoteException {
		return fachadaProjeto.obterArquivoProjeto(projetoDto, arquivoDTO);
	}

	@Override
	public ResultadoListagemEmpresaDTO obterListagemEmpresa() throws RemoteException {
		return fachadaProjeto.obterListagemEmpresa();
	}

	@Override
	public ResultadoValidacaoPatrocinioDTO validarPatrocinio(PatrocinioDTO patrocinioDto) throws RemoteException {
		return fachadaProjeto.validarPatrocinio(patrocinioDto);
	}

	@Override
	public ResultadoListagemVulnerabilidadeDTO obterListagemVulnerabilidadeParaUsuario() throws RemoteException {
		return fachadaGrupo.obterListagemVulnerabilidadeParaUsuario();
	}

	@Override
	public ResultadoListagemVulnerabilidadeDTO obterListagemVulnerabilidadeParaFamilia() throws RemoteException {
		return fachadaGrupo.obterListagemVulnerabilidadeParaFamilia();
	}

	@Override
	public ResultadoListagemEncaminhamentoDTO obterListagemEncaminhamento() throws RemoteException {
		return fachadaUsuario.obterListagemEncaminhamento();
	}

	@Override
	public ResultadoListagemRelacaoRecursoDTO obterListagemRelacaoRecurso() throws RemoteException {
		return fachadaUsuario.obterListagemRelacaoRecurso();
	}

	@Override
	public ResultadoValidacaoRecursoRelacionamentoDTO validarRecursoRelacionamento(
			RecursoRelacionamentoDTO recursoRelacionamentoDto) throws RemoteException {
		return fachadaUsuario.validarRecursoRelacionamento(recursoRelacionamentoDto);
	}
}