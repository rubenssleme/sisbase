...
public class ParticipacaoDetalhada extends Validavel implements ValidavelObrigatoriedadeETamanhoMaximo {
	...
	private void validarObrigatoriedade() {
		...
		validarApenasUsuarioInvalido();
	}
	
	private void validarApenasUsuarioInvalido(){
		if (participacao != null && participacao.equals(Participacao.APENAS_USUARIO) && quantidade > 1) {
			adicionarErro("Insira somente uma pessoa na participação.");
		}
	}
