...
public class GerenciadorReuniaoIntegracao {
	...
	public ModuloPeriodo obterModuloPeriodoReuniaoIntegracaoComDataFuturaEPeriodoCompativel(
		...
		return repositorioGrupo
				.obterModuloPeriodoServicoSocialReuniaoIntegracaoAtivosComDataFutura(moduloPeriodo)
	...
	public List<Usuario> obterUsuariosIntegradosEmReuniaoDeIntegracaoSemAtendimentoComFrequenciaAT(
			ModuloPeriodo moduloPeriodoSolicitante) {
		List<Usuario> usuarioIntegradosEmReunicaoDeIntegracaoSemAtendimentoComFrequenciaAT = new ArrayList<>();
		if (!moduloPeriodoSolicitante.ePossuiModuloDeReuniaoIntegracao()) {
			List<Usuario> usuariosComStatusAcessoOuIntegrado = moduloPeriodoSolicitante
					.obterUsuariosComStatusAcessoOuIntegrado();
			for (Usuario usuario : usuariosComStatusAcessoOuIntegrado) {
				Grupo grupoAtivoMaisRecenteDeReuniaoDeIntegracaoComUsuarioIntegrado = repositorioGrupo
						.obterGrupoAtivoMaisRecenteDeReuniaoDeIntegracaoComUsuarioIntegrado(usuario);
				if (grupoAtivoMaisRecenteDeReuniaoDeIntegracaoComUsuarioIntegrado != null
						&& !grupoAtivoMaisRecenteDeReuniaoDeIntegracaoComUsuarioIntegrado
								.possuiAtendimentoNormalComFrequenciaAT(usuario)) {
					usuarioIntegradosEmReunicaoDeIntegracaoSemAtendimentoComFrequenciaAT.add(usuario);
				}
			}
		}
		return usuarioIntegradosEmReunicaoDeIntegracaoSemAtendimentoComFrequenciaAT;
	}
}
