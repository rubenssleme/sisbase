...
public class TestesUsuarioDTO {
	...
	public void usuariodto_foi_construido_com_sucesso() {
		...
		TelefoneDTO telResidencial = new TelefoneDTO(new TipoTelefoneDTO(
				"RESIDENCIAL"), "38743443", "1234", "PAULO");
		TelefoneDTO telCelular = new TelefoneDTO(
				new TipoTelefoneDTO("CELULAR"), "47834883", "1234", "PAULO");
		...
		List<RecursoRelacionamentoDTO> recursosRelacionamentoDto = Arrays.asList(new RecursoRelacionamentoDTO());
		...
		usuarioDto.setRecursosRelacionamentoDto(recursosRelacionamentoDto);
		...
		usuarioDto.setVulnerabilidadeUsuarioDto(vulnerabilidadeDTOs);
		...
		Assert.assertEquals(usuarioDto.getRecursosRelacionamentosDto().size(), 1);
		...
		Assert.assertEquals(usuarioDto.getVulnerabilidadeUsuarioDto().size(), vulnerabilidadeDTOs.size());
	}
}
