...
public class TestesDemandaDTO {
	...
	public void demandadto_foi_construida_com_sucesso() {
		...
		RecursoDTO recursoDto = new RecursoDTO(id, "ABC", false, false, "100,00", Arrays.asList(new DescricaoRecursoDTO(new Long(1), "Descruicao recurso")));
		...
		demandaDto.setDataExpectativa(data);
		...
		Assert.assertEquals(demandaDto.getDataExpectativa(), data);
	}
}
