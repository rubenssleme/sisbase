...
public class UsuarioDTO extends ModeloDTO implements Identificavel, Bloqueavel {
	...
	private List<VulnerabilidadeDTO> vulnerabilidadeUsuarioDto;
	...
	private List<RecursoRelacionamentoDTO> recursosRelacionamentosDto;
	...
	private List<OrigemEncaminhamentoDetalhadoDTO> origemEncaminhamentosDetalhadosDto;
	...
	public UsuarioDTO(){
		...
		vulnerabilidadeUsuarioDto = new ArrayList<>();
		recursosRelacionamentosDto = new ArrayList<>();
		...
		origemEncaminhamentosDetalhadosDto = new ArrayList<>();
	...
	public List<OrigemEncaminhamentoDetalhadoDTO> getOrigemEncaminhamentosDetalhadosDto() {
		return origemEncaminhamentosDetalhadosDto;
	}

	public void setOrigemEncaminhamentosDetalhadosDto(List<OrigemEncaminhamentoDetalhadoDTO> encaminhamentosDto) {
		this.origemEncaminhamentosDetalhadosDto = encaminhamentosDto;
	}
	...
	public List<VulnerabilidadeDTO> getVulnerabilidadeUsuarioDto() {
		return vulnerabilidadeUsuarioDto;
	}

	public void setVulnerabilidadeUsuarioDto(List<VulnerabilidadeDTO> vulnerabilidadeUsuarioDto) {
		this.vulnerabilidadeUsuarioDto = vulnerabilidadeUsuarioDto;
	}
	...
	public List<RecursoRelacionamentoDTO> getRecursosRelacionamentosDto() {
		return recursosRelacionamentosDto;
	}

	public void setRecursosRelacionamentoDto(List<RecursoRelacionamentoDTO> recursosRelacionamentosDto) {
		this.recursosRelacionamentosDto = recursosRelacionamentosDto;
	}
