...
public class FamiliarDTO extends ModeloDTO implements Identificavel {
	...
	private List<VulnerabilidadeDTO> vulnerabilidadesDto;
	...
	public FamiliarDTO(){
		...
		vulnerabilidadesDto = new ArrayList<>();
	}
	...
	public List<VulnerabilidadeDTO> getVulnerabilidadesDto() {
		return vulnerabilidadesDto;
	}

	public void setVulnerabilidadesDto(List<VulnerabilidadeDTO> vulnerabilidadesDto) {
		this.vulnerabilidadesDto = vulnerabilidadesDto;
	}
}
