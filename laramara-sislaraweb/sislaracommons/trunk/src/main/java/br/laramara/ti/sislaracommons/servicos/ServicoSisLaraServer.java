...
public interface ServicoSisLaraServer extends Remote {
	...
	public ResultadoValidacaoDescricaoEventoDTO validarDescricaoEvento(DescricaoEventoDTO descricaoEventoDto) throws RemoteException;
	...
	public ResultadoValidacaoRecursoDisponivelDTO validarRecursoDisponivel(
			RecursoDisponivelDTO recursoDisponivelDto) throws RemoteException;
	...
	public ArquivoDTO gerarRelatorioDeAvaliacaoPsicossocial(Long prontuario,
			TokenDTO tokenDto) throws RemoteException;
	...
	public ResultadoEdicaoUsuarioExternoDTO editarUsuarioExterno(SolicitacaoEdicaoUsuarioExternoDTO solicitacaoEdicaoUsuarioExternoDTO) throws RemoteException;

	public ResultadoCadastroInscricaoDTO cadastrarInscricao(
			SolicitacaoCadastroInscricaoDTO solicitacaoCadastroInscricaoDto) throws RemoteException;
	
	public ResultadoCadastroUsuarioExternoDTO cadastrarUsuarioExterno(
			SolicitacaoCadastroUsuarioExternoDTO solicitacaoCadastroUsuarioExternoDto) throws RemoteException;
}