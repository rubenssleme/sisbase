update modulo_usuario set status='REMOVIDO', obs='Já participou de atividade de integração anteriormente.' where id in(
	...
	where modusu.status = 'INTEGRADO' and gru.ativo = true and gru.excluido is false and gru.data_inicio between '01/01/2016' and '31/12/2016' and nomgru.nome = 'SS' and gru.turma = '16' 
and usu.id in (
10898
,9533
,10911 
