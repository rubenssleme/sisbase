...
insert into atendimento_usuario(id_usuario, id_informacao_atendimento)values(7424, currval('informacao_atendimento_id_seq'));
insert into atendimento_grupo_atendimento_usuario(
	...
	where gru.ativo = true and excluido = false and nom.nome = 'G10' and gru.turma = '02' and mod.nome = 'Atendimento Específico Especializado' and ate.data in ('22/09/2015'));