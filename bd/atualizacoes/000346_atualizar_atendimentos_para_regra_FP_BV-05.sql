...
where infatepro.frequencia = 'FP' and gru.ativo = true and ategru.status ='NORMAL' and nom.nome like 'BV' and gru.turma like '05' and ategru.data in ('2016-04-13', '2016-09-14', '2016-09-21', '2016-09-28')
