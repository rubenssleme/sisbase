...
where infatepro.frequencia = 'FP' and gru.ativo = true and ategru.status ='NORMAL' and nom.nome like 'BR' and gru.turma like '05' and ategru.data in ('2016-09-14', '2016-09-21', '2016-09-28')
