...
public class EsperaUtils extends SwingWorker<Void, Void> {
    ...
    public EsperaUtils(Runnable comando, JFrame tela) {
        this(null, comando, tela);
    }
    
    private EsperaUtils(JButton jbu, Runnable comando, Window tela) {
        this.jbu = jbu;
        this.tela = tela;
    ...
    private void configurarComponentes(boolean valor, Container container) {
        ...
        for (Component component : components) {
            if (!(component instanceof JCalendar) && !(component instanceof  JDayChooser) && !(component instanceof JMonthChooser) &&  !(component instanceof JYearChooser) && !(component instanceof JLabel)){
