...
public class TelaGruposEditarDescricaoIndividualProfissional extends TelaGruposEditarDescricaoIndividual {
    ...
    public TelaGruposEditarDescricaoIndividualProfissional(JDialog parent, GrupoDTO grupoDto, ModuloPeriodoDTO moduloPeriodoDto, AtendimentoGrupoDTO atendimentoDto, AtendimentoBaseDTO atendimentoBaseDto) {
        ...
        controlador = new ControladorTelaGruposEditarDescricaoIndividualProfissional(this, grupoDto, moduloPeriodoDto, atendimentoDto, atendimentoBaseDto, jtfGrupo, jtfModuloAtividade, jtfData, jtfHoraInicio, jtfHoraTermino, jtfNome, jpaParticipacao, jcbParticipacaoSelecionada, jtfQuantidadePessoas, jliParticipacoesAdicionadas, jatDescricaoIndividual, jcbFrequencia, jatJustificativa, jliArquivos);
