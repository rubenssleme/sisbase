...
public class TelaGruposEditarDescricaoIndividualComunidade extends TelaGruposEditarDescricaoIndividual{
    ...
    public TelaGruposEditarDescricaoIndividualComunidade(JDialog parent, GrupoDTO grupoDto, ModuloPeriodoDTO moduloPeriodoDto, AtendimentoGrupoDTO atendimentoDto, AtendimentoBaseDTO atendimentoBaseDto){
        ...
        controlador = new ControladorTelaGruposEditarDescricaoIndividualComunidade(this, grupoDto, moduloPeriodoDto, atendimentoDto, atendimentoBaseDto, jtfGrupo, jtfModuloAtividade, jtfData, jtfHoraInicio, jtfHoraTermino, jtfNome, jpaParticipacao, jcbParticipacaoSelecionada, jtfQuantidadePessoas, jliParticipacoesAdicionadas, jatDescricaoIndividual, jcbFrequencia, jatJustificativa, jliArquivos);
