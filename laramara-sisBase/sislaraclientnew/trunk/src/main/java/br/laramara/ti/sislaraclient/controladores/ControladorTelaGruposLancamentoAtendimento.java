...
public class ControladorTelaGruposLancamentoAtendimento extends ControladorTelaEditar {
    ...
    protected ResultadoDTO solicitarEdicaoDto() throws Exception {
        return null;
        //servicoSisLaraServer.gerarAtendimentos(new EspecificacaoGeracaoAtendimentosDTO(obterObjetoDTO().getId(), moduloAtividadePeriodoDto.getId(), jftData.getText(), jftHoraInicio.getText(), jftHoraTermino.getText()), Sessao.obterInstancia().obterToken());
    }
