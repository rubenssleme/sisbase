...
public class ControladorTelaGruposEditarAtendimentos extends ControladorTelaEditar implements TabelaConfiguravel {
    ...
    public ControladorTelaGruposEditarAtendimentos(JDialog telaPai, GrupoDTO grupoDto, ModuloPeriodoDTO moduloPeriodoDto, AtendimentoGrupoDTO atendimentoGrupoDto, boolean bloquearGrupo, JTextField jtfGrupo, JTextField jtfModuloAtividade, JFormattedTextField jftData, JFormattedTextField jftHoraInicio, JFormattedTextField jftHoraTermino, JTextArea jatDescricao, JTextArea jatInterdisciplinar, JTable jtaAtendimentosUsuario, JTable jtaAtendimentosComunidade, JTable jtaAtendimentosProfissinais, JList jliArquivos){
        ...
        carregarCampos();
        habilitarCamposDataEHorarioSeNecessario(atendimentoGrupoDto);
    ...
    protected ResultadoDTO solicitarEdicaoDto() throws Exception {
        return servicoSisLaraServer.editarAtendimentoGrupo(moduloPeriodoDTO, obterObjetoDTO(), Sessao.obterInstancia().obterToken());
    }
    ...
    protected void prepararDtoParaEditar() {
        ...
        atendimentoAAlterarDto.setData(jftData.getText());
        atendimentoAAlterarDto.setHorarioDto(new HorarioDTO(jftHoraInicio.getText(), jftHoraTermino.getText()));
    }
    ...
    private void habilitarCamposDataEHorarioSeNecessario(AtendimentoGrupoDTO atendimentoGrupoDto) {
        if (atendimentoGrupoDto.getData().isEmpty()){
            jftData.setEditable(true);
            jftData.setBackground(Color.WHITE);
            jftHoraInicio.setEditable(true);
            jftHoraInicio.setBackground(Color.WHITE);
            jftHoraTermino.setEditable(true);
            jftHoraTermino.setBackground(Color.WHITE);
        }
    }
}
