  ...
  @Override
    public void carregarCampos() {
        if (verificarSeDtoEstaPreenchido()) {
            ...
            jftCpf.setText(obterObjetoDTO().getCpf());
    ...
    protected void prepararDtoParaEditar() {
        ...
        obterObjetoDTO().setCpf(jftCpf.getText());
