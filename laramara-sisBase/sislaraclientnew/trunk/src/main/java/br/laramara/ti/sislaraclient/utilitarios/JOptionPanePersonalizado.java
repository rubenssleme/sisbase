...
public class JOptionPanePersonalizado {
    ...
    public static final String ERRO_DURANTE_ADICAO_PARTICIPACAO_DETALHADA = "Erro durante adição de participacao detalhada. \n";
    ...
    public static final String ERRO_VALIDACAO_ACAO_CONDUTA = "Erro durante validação de conduta.";
    public static final String ERRO_GERACAO_MODELO_ATENDIMENTO = "Erro durante geração de modelo de atendimento.";
    public static final String ERRO_DURANTE_ADICAO_ENCAMINHAMENTO = "Erro durante adição de encaminhamento";
