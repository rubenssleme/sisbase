...
public abstract class ControladorTelaRelatorioAtendimentoPorUsuario extends ControladorTela{
    ...
    public ControladorTelaRelatorioAtendimentoPorUsuario(JDialog telaPai, JTextField jtfGrupo, JComboBox jcbModuloAtividade){
        this(telaPai, jtfGrupo, jcbModuloAtividade, null);
    }
