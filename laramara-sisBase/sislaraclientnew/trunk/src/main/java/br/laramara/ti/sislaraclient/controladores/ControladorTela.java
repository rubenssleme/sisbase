...
abstract class ControladorTela {
    ...
    protected boolean estaComItemValidoSelecionado(JComboBox jComboBox){
        return jComboBox != null && jComboBox.getSelectedIndex() != 0;
    }
    ...
    protected void adicionarDtoNoItemSelecionado(JList jli, ModeloDTO objetoDto) {
        int indice = jli.getSelectedIndex();
        DefaultListModel modeloLista = ((DefaultListModel) jli.getModel()); 
        modeloLista.setElementAt(objetoDto, indice);
    }
    ...
    public boolean teclaEnterPressionada(KeyEvent evt) {
