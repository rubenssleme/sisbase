update grupo set ativo = false where id in (
	...
	WHERE gru.ativo is true and gru.data_inicio between '01/01/2018' and '31/12/2018' and nom.nome||'-'||gru.turma in ('PSS-01', 'PSS-02', 'PSS-03', 'PSS-04', 'PSS-05', 'PSS-06', 'PSS-07', 'PSS-08', 'PSS-09')
);
...
update grupo set ativo = true where id in (
	select distinct gru.id from grupo gru
				...
				inner join nome_grupo nom
					on nom.id = gru.id_nome_grupo
	WHERE gru.ativo is false and gru.data_inicio between '01/01/2017' and '31/12/2017' and nom.nome||'-'||gru.turma in ('PSS-01', 'PSS-02', 'PSS-03', 'PSS-04', 'PSS-05', 'PSS-06', 'PSS-07', 'PSS-08', 'PSS-09')
);
