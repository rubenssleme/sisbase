...
import br.laramara.ti.sislaraserver.fabricas.FabricaRedeEncaminhamento;
...
import br.laramara.ti.sislaraserver.repositorios.RepositorioRedeEncaminhamento;
...
public class FachadaUsuario extends Fachada {
	...
	@Inject
	private RepositorioRedeEncaminhamento repositorioRedeEncaminhamento;
	@Inject
	...
	public ResultadoListagemRedeEncaminhamentoDTO obterListagemRedeEncaminhamento() {
		return (ResultadoListagemRedeEncaminhamentoDTO) obterListagem(
				repositorioRedeEncaminhamento.obterTodos(), new FabricaRedeEncaminhamento(),
				"Rede Encaminhamento", new ResultadoListagemRedeEncaminhamentoDTO());
	}
}
