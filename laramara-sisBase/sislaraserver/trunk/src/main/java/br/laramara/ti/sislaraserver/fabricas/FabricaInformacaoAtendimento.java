	...
	public InformacaoAtendimentoDTO converterParaDTO(
		...
		if (informacoesAtendimento != null) {
			...
			informacoesAtendimentoDto.setJustificativa(informacoesAtendimento
					.getJustificativa());
			informacoesAtendimentoDto.setParticipadaoDetalhadaDto(new FabricaParticipacaoDetalhada()
					.converterParaDTO(informacoesAtendimento.getParticipacaoDetalhada()));
		}
	...
	public InformacaoAtendimento converterParaDominio(
		...
		if (informacoesAtendimentoDto != null) {
			...
			informacoesAtendimento.setJustificativa(informacoesAtendimentoDto
					.getJustificativa());
			informacoesAtendimento.setParticipacaoDetalhada(new FabricaParticipacaoDetalhada()
					.converterParaDominio(informacoesAtendimentoDto.getParticipacaoDetalhadaDto()));
		}
