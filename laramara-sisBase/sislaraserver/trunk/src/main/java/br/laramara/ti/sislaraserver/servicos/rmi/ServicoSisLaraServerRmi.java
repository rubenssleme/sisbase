...
public class ServicoSisLaraServerRmi implements ServicoSisLaraServer {
	...
	@Override
	public ResultadoListagemRedeEncaminhamentoDTO obterListagemRedeEncaminhamento() throws RemoteException {
		return fachadaUsuario.obterListagemRedeEncaminhamento();
	}

	@Override
	public ResultadoValidacaoEncaminhamentoDTO validarEncaminhamento(EncaminhamentoDTO encaminhamentoDto)
			throws RemoteException {
		return fachadaGrupo.validarEncaminhamento(encaminhamentoDto);
	}
