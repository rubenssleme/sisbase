...
import br.laramara.ti.sislaraserver.dominio.seguranca.UsuarioExternoNaoAutenticadoException;
...
public class FachadaSeguranca extends Fachada {
	...
	public ResultadoAutenticacaoDTO autenticarUsuarioExterno(CredencialExternaDTO credencialExternaDto) {
		...
		CredencialExterna credencialExterna = new FabricaCredencialExterna()
