...
public class Registro {
	...
	public static RepositorioRedeEncaminhamento obterRepositorioRedeEncaminhamento() {
		inicializarContexto();
		return (RepositorioRedeEncaminhamento)(contexto.getBean(RepositorioRedeEncaminhamento.class));
	}
