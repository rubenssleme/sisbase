...
public class TestesAtendimentoPreCadastro {
	
	@Test(groups = { TiposDeTeste.UNITARIO })
	public void atendimentoprecadastro_validacao_com_erro_obrigatoriedade_e_tamanho_maximo() {
		AtendimentoPreCadastro atendimento = new AtendimentoPreCadastro();
